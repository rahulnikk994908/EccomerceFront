...
export default function Navigation() {
  ...
  useEffect(() => {
    console.log("in use effect",auth.user)
    if (auth.user){ 
                  ...
                  <Tab.Panels as={Fragment}>
                    {navigation.categories.map((category) => (
                      ...
                      >
                        ...
                        {category.sections.map((section,close) => (
            ...
            <div className="flex h-16 items-center px-11">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to="/">
                  ...
                  <img 
                    src="https://www.logomaker.com/api/main/images/1j+ojFVDOMkX9Wytexe43D6kh...OIpBJIkRbFwXs1M3EMoAJtlikqhvZt9vg+ "
                    alt="Shopwithzosh"
